...
const CabinetSelectForm: React.FunctionComponent<ICabinetSelectFormProps> = (props) => {
            ...
            <div className='cab-money-add-cabinet-select-container'>
                ...
                <div className='cab-money-add-credentials'>
                    <div className='cab-money-add-credentials-input-container'>
                        ...
                        <input value={amount === 0 ? '' : amount} onChange={e => setAmount(e.target.value === '' ? 0 : parseInt(e.target.value))} type='number' placeholder={'Сумма пополнения (₽)'}></input>
                    </div>
                    <div className='cab-money-add-credentials-input-container'>
                        <span><i className="far fa-envelope"></i></span>
                        <input value={email} onChange={e => setEmail(e.target.value)} type='email' placeholder={'Электронная почта'}></input>
                    </div>
                </div>
                ...
                <button className='cab-money-add-submit'>
                    Пополнить
                </button>
            </div>
